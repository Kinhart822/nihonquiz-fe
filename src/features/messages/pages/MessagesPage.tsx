...
import { mockMessages } from '../../lms/mock/mockMessages';

export const MessagesPage: React.FC = () => {
  const [activeThreadId, setActiveThreadId] = useState(mockMessages[0].id);
  ...
  return (
    <DashboardLayout>
      <div className="w-full h-full bg-white dark:bg-slate-900 flex overflow-hidden">
        {/* Sidebar */}
        <div className="w-full md:w-80 lg:w-96 border-r border-gray-100 dark:border-slate-800 flex flex-col">
