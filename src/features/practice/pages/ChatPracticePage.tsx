  ...
  return (
    <DashboardLayout>
      <div className="w-full px-4 py-8 md:px-8 md:py-12 lg:px-16 xl:px-24 h-full flex flex-col">
        <div className="mb-6">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-400 rounded-full text-xs font-semibold uppercase tracking-wider mb-4 border border-green-100 dark:border-green-800/50 transition-colors">
        ...
        <div className="flex-1 bg-white dark:bg-slate-900 rounded-xl border border-gray-200 dark:border-slate-800 shadow-sm flex flex-col overflow-hidden min-h-[500px] transition-colors">
          {/* Chat Messages */}
          <div className="flex-1 overflow-y-auto p-6 space-y-6 bg-gray-50/50 dark:bg-slate-950/50 transition-colors">
            {messages.map((msg, idx) => (
              ...
              >
                ...
                <div
                  className={`max-w-[80%] rounded-2xl p-4 transition-colors ${msg.role === 'user' ? 'bg-blue-600 dark:bg-blue-600 text-white rounded-tr-none' : 'bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 shadow-sm rounded-tl-none text-gray-800 dark:text-slate-200'}`}
                >
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 relative">
                <input
                  ...
                  className="w-full bg-gray-50 dark:bg-slate-800 border border-gray-200 dark:border-slate-700 text-gray-800 dark:text-slate-200 rounded-xl px-4 py-3.5 pr-12 outline-none focus:border-blue-500 dark:focus:border-blue-500 focus:ring-1 focus:ring-blue-500 dark:focus:ring-blue-500/50 transition-all font-medium"
                />
              </div>
