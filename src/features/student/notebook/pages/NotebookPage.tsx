        ...
        <div className="flex flex-col lg:flex-row gap-8 w-full animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <div className="flex-1">
            {filteredWords.length > 0 ? (
              ...
              <div className="w-full py-24 flex flex-col items-center justify-center bg-white/50 dark:bg-slate-900/50 rounded-3xl border border-dashed border-gray-200 dark:border-slate-700 text-center px-4">
