...
export const WordCard: React.FC<WordCardProps> = ({ word, onUnfavorite }) => {
  ...
  return (
    <div className="group bg-white dark:bg-slate-900 rounded-3xl p-6 border-2 border- dark:border-slate-700 shadow-sm hover:shadow-xl hover:border-teal-300 dark:hover:border-teal-700 transition-all duration-300 relative overflow-hidden flex flex-col h-full cursor-pointer">
      ...
      <div className="flex justify-between items-start mb-6 relative z-10">
        <div className="flex items-center gap-2">
          <span className="px-3 py-1 text-xs font-black bg-teal-50 text-teal-700 dark:bg-teal-900/40 dark:text-teal-300 rounded-lg border-2 border- dark:border-teal-800/50 shadow-sm">
            {word.level}
          </span>
      ...
      <div className="mt-auto relative z-10 border-t border-gray-200 dark:border-slate-700 pt-5">
