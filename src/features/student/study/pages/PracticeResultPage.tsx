    ...
    <>
      <div className="w-full max-w-4xl mx-auto px-4 py-8 md:px-8 md:py-16 flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full mb-12">
          <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border-2 border- dark:border-slate-700 shadow-sm text-center flex flex-col items-center justify-center">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border-2 border- dark:border-slate-700 shadow-sm text-center flex flex-col items-center justify-center relative overflow-hidden">
