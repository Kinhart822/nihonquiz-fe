  ...
  return (
    <>
      <div className="w-full max-w-5xl mx-auto px-4 py-8 md:px-8 md:py-12">
        ...
        {/* Header Banner */}
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-8 md:p-10 border-2 border- dark:border-slate-700 shadow-sm relative overflow-hidden mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 border-2 border- dark:border-slate-700 shadow-sm flex items-center gap-4">
        ...
        {/* History & Progress */}
        {history && (
          <div className="bg-white dark:bg-slate-900 rounded-3xl p-8 border-2 border- dark:border-slate-700 shadow-sm">
