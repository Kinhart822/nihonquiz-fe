...
export const TopicCard: React.FC<TopicCardProps> = ({
  ...
  return (
    <div className="group bg-white dark:bg-slate-900 rounded-2xl p-6 border-2 border- dark:border-slate-700 shadow-sm hover:shadow-xl hover:border-teal-300 dark:hover:border-teal-700 transition-all duration-300 flex flex-col h-full cursor-pointer relative overflow-hidden">
