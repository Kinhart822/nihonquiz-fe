...
} from '../../dashboard/mock/mockAssignments';
  ...
  return (
    <>
      <div className="w-full max-w-5xl mx-auto px-4 py-8 md:px-8 md:py-12">
        ...
        {/* Tabs */}
        <div className="flex items-center gap-2 mb-8 bg-gray-50 dark:bg-slate-900 p-1.5 rounded-2xl overflow-x-auto no-scrollbar border-2 border- dark:border-slate-700">
          <button
        ...
        <div className="space-y-4">
          {filteredAssignments.length === 0 ? (
            <div className="text-center py-16 bg-white dark:bg-slate-900 rounded-3xl border-2 border- dark:border-slate-700">
              <ClipboardList
                size={48}
            ...
            filteredAssignments.map((assignment) => (
              <div
                key={assignment.id}
                className="bg-white dark:bg-slate-900 rounded-3xl p-6 border-2 border- dark:border-slate-700 shadow-sm hover:shadow-md transition-all group flex flex-col md:flex-row gap-6 md:items-center justify-between"
              >
