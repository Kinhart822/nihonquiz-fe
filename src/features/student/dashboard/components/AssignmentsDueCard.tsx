        ...
        {dueAssignments.length === 0 ? (
          ...
          dueAssignments.map((assignment) => (
            <div
              key={assignment.id}
              onClick={() => navigate(`/assignments`)}
              className="group flex flex-col p-4 bg-gray-50 dark:bg-slate-800/50 rounded-2xl cursor-pointer hover:bg-red-50 dark:hover:bg-red-900/10 border-2 border- hover:border-red-100 dark:hover:border-red-900/30 transition-all duration-300"
            >
