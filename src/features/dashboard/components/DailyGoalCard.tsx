...
export const DailyGoalCard: React.FC = () => {
  return (
    <div className="bg-white dark:bg-slate-900 rounded-xl p-6 border border-gray-100 dark:border-slate-800 shadow-sm transition-colors">
      ...
      <button className="w-full mt-6 py-2.5 bg-gray-50 dark:bg-slate-800/50 hover:bg-gray-100 dark:hover:bg-slate-800 text-gray-700 dark:text-slate-300 text-sm font-bold rounded-lg transition-colors border border-gray-200 dark:border-slate-700">
        Xem tất cả mục tiêu
      </button>
    </div>
  );
